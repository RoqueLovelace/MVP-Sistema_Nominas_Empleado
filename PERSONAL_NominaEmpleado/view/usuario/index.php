...
// URL de la API para obtener todos los registros de contratación
$url = "http://127.0.0.1:8000/api/contratacion";
$contrataciones = getApiData($url);
                            ...
                            <div class="container">
                                <div class="row">
                                    <div class="mb-3 text-center">
                                        ...
                                        <a href="../../view/usuario/crear_contrato.php"
                                            class="btn btn-primary">Registrar Contratación</a>
                                    </div>
                                </div>
                                <table class="table table-striped">
                                    ...
                                    <tbody>
                                        <?php if (!empty($contrataciones['contrataciones']) && is_array($contrataciones['contrataciones'])): ?>
                                        <?php foreach ($contrataciones['contrataciones'] as $contratacion): ?>
                                        <tr>
                                            <td>
                                                <?php echo htmlspecialchars($contratacion['id_colaborador'] ?? 'N/A'); ?>
                                            </td>
                                            <td>
                                                <?php echo htmlspecialchars($contratacion['supervisor'] ?? 'N/A'); ?>
                                            </td>
                                            <td>
                                                <?php echo htmlspecialchars($contratacion['tipo_contratacion'] ?? 'N/A'); ?>
                                            </td>
                                            <td>
                                                <?php echo htmlspecialchars($contratacion['fecha_inicio_contrato'] ?? 'N/A'); ?>
                                            </td>
                                            <td>
                                                <?php echo htmlspecialchars($contratacion['fecha_fin_contrato'] ?? 'N/A'); ?>
                                            </td>
                                            <td>
                                                <a href="" class="btn btn-warning btn-sm">Editar</a>
                                                <a href="" class="btn btn-danger btn-sm"
                                                    onclick="return confirm('¿Estás seguro de eliminar esta contratación?')">Eliminar</a>
                                            </td>
                                        </tr>
                                        <?php endforeach; ?>
                                        <?php else: ?>
                                        <tr>
                                            <td colspan="6">No hay contrataciones registradas.</td>
                                        </tr>
                                        <?php endif; ?>
                                    </tbody>
                                </table>
