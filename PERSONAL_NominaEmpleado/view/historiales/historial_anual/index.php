...
// URL de la API para obtener el total de horas anuales
$url_annual_hours = "http://127.0.0.1:8000/api/assistence/annual-hours/$id/$year";
...
// Obtener los datos de la API para las horas anuales
            ...
            <div class="page-content">
                <div class="container-fluid">
                            ...
                            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                ...
                                <div class="page-title-right">
                                    <ol class="breadcrumb m-0">
                                        ...
                                        <li class="breadcrumb-item active">Horas Totales</li>
                                    </ol>
                                </div>
                    ...
                    <div class="row justify-content-center align-items-center">
                        ...
                        <div class="container mt-4">
                            <div class="text-center mb-4">
                                ...
                                <form method="GET" action="" class="d-flex justify-content-center">
                                    <select name="year" id="year-select" class="form-control w-auto"
                                    ...
                                    <button id="search-button" class="btn btn-outline-primary ms-2"
                                ...
                                <div class="row mb-5">
                                    <div class="col-9">
                                        <div class="row row-cols-3 g-4">
                                            ...
                                            <div class="col">
                                                <a href="semana.php?year=<?php echo $year; ?>&month=<?php echo $monthNumber; ?>"
                                                    class="text-decoration-none text-dark">
                                                    <div class="card month-card h-100 shadow-lg"
                                    ...
                                    <div class="col-3">
                                        <div class="card h-100 shadow-lg" style="border-radius: 15px;">
                                            <div
                                                ...
                                                <button id="show-hours" class="btn btn-outline-primary mb-3">Mostrar
                                                    total de horas</button>
                                                <div id="total-hours-container" style="display: none;">
                                                    <h5 class="card-title" style="font-size: 1.5rem;">Total de horas
                                                    </h5>
                                                    <p class="card-text display-4" id="total-horas">
                                                        <?php echo 'N/A'; ?>
                                                    </p>
                                                </div>
                                            </div>
                        ...
                        <script>
                            document.getElementById('show-hours').addEventListener('click', function () {
                                var totalHoras = document.getElementById('total-horas');
                                var totalHoursContainer = document.getElementById('total-hours-container');

                                if (totalHoursContainer.style.display === 'none') {
                                    // Mostrar el contenedor y actualizar el total de horas
                                    totalHoursContainer.style.display = 'block';
                                    totalHoras.textContent = '<?php echo $data_annual_hours['total_horas_anuales'] ?? 'No disponible'; ?>';
                                } else {
